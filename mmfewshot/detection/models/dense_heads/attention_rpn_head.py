...
class AttentionRPNHead(RPNHead):
    ...
    def __init__(self,
                 ...
                 aggregation_layer: Dict = dict(
                     ...
                     aggregator_cfgs=[
                         dict(type='DepthWiseCorrelationAggregator',
                              in_channels=1024,
                              with_fc=False)
                     ]),
                 roi_extractor: Dict = dict(type='SingleRoIExtractor',
    ...
    def forward_train(self,
        ...
        proposal_list = self.get_bboxes(*outs,
                                        img_metas=repeat_query_img_metas,
                                        cfg=proposal_cfg)
    ...
    def simple_test(self,
        ...
        feats = self.aggregation_layer(query_feat=query_feats[0],
