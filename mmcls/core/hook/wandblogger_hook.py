...
class MMClsWandbHook(WandbLoggerHook):
    ...
    def __init__(self,
        ...
        self.log_checkpoint_metadata = (log_checkpoint
                                        and log_checkpoint_metadata)
    ...
    def _log_ckpt_as_artifact(self, model_path, aliases, metadata=None):
        ...
        """
        model_artifact = self.wandb.Artifact(f'run_{self.wandb.run.id}_model',
                                             type='model',
                                             metadata=metadata)
    ...
    def _log_eval_table(self, idx):
        ...
        """
        pred_artifact = self.wandb.Artifact(f'run_{self.wandb.run.id}_pred',
                                            type='evaluation')
